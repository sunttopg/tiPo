...
const page = () => {
    ...
    const rasp = () => {
        alert("Raspunsul corect era autoapelarea");
    }
    ...
    return (
        <main className="flex w-full h-screen justify-center items-center bg-gray-800 p-8">
            <div className='h-[400px] w-[600px] bg-white rounded-lg mt-[7px]'>
                <h1 className='text-5xl font-bold text-center my-[30px] text-primary text-black'>TEST#12</h1>
                <p className="text-xl pt-[10px] pb-[35px] text-black text-center">Ce propietate defineste recursivitatea?</p>
