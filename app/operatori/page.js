            ...
            <div className="bg-slate-100 p-12 rounded-lg shadow-2xl w-full max-w-xl">
                {
                    showScore ?(
                        ...
                        <br></br>
                        <button className=" m-2 h-10 w-24 text-semibold text-white rounded-md bg-purple-600 hover:bg-purple-700 hover:shadow-xl tranzition-all duration-500"onClick={() => {window.location.reload()}}>Reincearca</button>
                        </>
                    ) : (
