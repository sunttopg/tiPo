export default function Tipuri (){
    ...
    return(
        ...
        <main className="bg-gray-800 p-6">
            ...
            <div className="text-black bg-white rounded-md ml-200 mt-[0vw] ml-[13vw] text-lg font-semibold text-left p-10">
                <div>
                    ...
                    <ul className="p-2 ">
                        <li className=" hover:text-purple-800 font-extrabold"><a class="nav-link" href="#tu">-Tablouri unidimensionale</a></li>
                        <li className=" hover:text-purple-800 font-extrabold"><a class="nav-link" href="#tb">-Tablouri bidimensionale</a></li>
                        <li className="hover:text-purple-800 font-extrabold"><a class="nav-link" href="#struct">-Struct</a></li>
                        <li className="hover:text-purple-800 font-extrabold"><a class="nav-link" href="#sc">-Șiruri de caractere</a></li>
                    </ul>
                </div>

                <div id="tu">
                    <h1 className="text-center p-8 mt-[5vw] text-purple-800 text-3xl font-extrabold">Tablouri unidimensionale</h1>
                    ...
                    <p className="text-xl font-extrabold p-4 underline md:underline-offset-4">int X[10];</p>
                    ...
                    <p className="p-2 text-xl font-extrabold">Exemplu : </p>
                    <p className="text-xl font-extrabold p-4 underline md:underline-offset-4">int n, X[10], m, Y[100], p;</p>


                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Parcurgerea unui tablou unidimensional</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Adăugarea unui element într-un vector</p>
                    ...
                    <p className="text-xl font-extrabold p-4 underline md:underline-offset-4"> X[n++] = val;</p>
                    <p className="p-2 text-xl font-extrabold">Exemplu : </p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Ștergerea</p>
                    ...
                    <div>
                        <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Exerciții</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Sortarea tablourilor</p>
                    <div>
                        <ul className="p-2 ">
                    ...
                    <div id="bule">
                        <p className="text-2xl  font-bold p-8 mt-[5vw] ">Metoda bulelor</p>
                        <div className="p-2 ">
                    ...
                    <div id="sselectie">
                        <p className="text-2xl  font-bold p-8 mt-[5vw] ">Sortarea prin selecție</p>
                        <div className="p-2 ">
                            <p >-fie un vector X[] cu n elemente;</p>
                    ...
                    <div id="sinsertie">
                        <p className="text-2xl  font-bold p-8 mt-[5vw] ">Sortare prin inserție</p>
                        <div className="p-2 ">
                            <p >-fie un vector X[] cu n elemente;</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Interclasarea tablourilor</p>
                    <p className="p-2">Ștergerea unui element dintr-un vector se referă la eliminarea unui element specific din vector, astfel încât structura vectorului rămâne intactă, dar fără acel element.</p>
                    <p className="p-2">O soluție foarte eficientă este interclasarea:</p>
                    <div className="p-2 ">
                            <p >-considerăm două tablouri, cu n, respectiv m elemente, ordonate crescăto</p>
                            <p >-cele două tablouri se parcurg concomitent;</p>
                            <p >-se alege valoarea mai mică dintre cele două elemente curente.Se adaugă în al treilea tablou.Se avansează numai în tabloul din care am ales valoarea de adăugat.</p>
                            <p >-parcurgerea unuia dintre cele două tablouri se încheie</p>
                            <p >-toate elementele din celălalt tablou, neparcurse încă, sunt adăugate în tabloul destinație</p>
                            <p >-tabloul destinație are p = n + m elemente</p>
                    </div>
                    <div className="p-4 text-purple-800">
                ...
                <div id="tb">
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Declararea matricelor. Referirea elementelor</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Parcurgerea tablourilor bidimensionale</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] ">Tablouri patratice</p>
                    ...
                    <p className="p-2">Indexare de la 0</p>
                    <div className="p-4 text-purple-800">
                        for(int i = 0 ; i  n ; i ++)    A[i][n - 1 - i];
                    </div>
                    <p className="p-2">Indexare de la 1</p>
                    <div className="p-4 text-purple-800">
                        for(int i = 0 ; i  n ; i ++)  A[i][n + 1 - i];
                    </div>
                ...
                <div id="struct">
                    <h1 className="text-center p-8 mt-[5vw] text-purple-800 text-3xl font-extrabold">Tipul struct</h1>

                    
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Declararea unei structuri</p>
                    <p className="p-2">Sintaxa generală a declarării unui tip de date struct este următoarea:</p>
                    <div className="p-4 text-purple-800">
                            <p className="p-2 ">struct [NUME_STRUCTURĂ]_______</p>
                            <p className="p-2 ">_[TIP1 NUME_CÂMP[, NUME_CÂMP[, ...]];]</p>
                            <p className="p-2 ">_[TIP2 NUME_CÂMP[, NUME_CÂMP[, ...]];]</p>
                            <p className="p-2 ">_...____________</p>
                            <p className="p-2 ">[LISTA DE VARIABILE];_______</p>
                    </div>
                    <p className="p-2 text-xl font-extrabold">Exemplu : </p>
                    ...
                    <div className="p-4 text-purple-800">
                            ...
                            <p className="p-2 ">;_____________</p>
                    </div>

                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Variabile de tip structură</p>
                ...
                <div id="sc">
                    <h1 className="text-center p-8 mt-[5vw] text-purple-800 text-3xl font-extrabold">Șiruri de caractere</h1>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Declarare</p>
                    <p className="p-2">Un șir de caractere se declară în C++ astfel:</p>
                    <p className="p-2 text-xl">char s[11];</p>
                    ...
                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4">Parcurgere</p>
                    <p className="p-2">În numeroase situații este necesară analizarea fiecărui caracter din șir. Pentru aceasta este necesară o parcurgere a șirului; aceasta se face similar cu parcurgerea unui tablou oarecare. Diferența constă în faptul că, pentru șirul de caractere nu se cunoaște explicit lungimea. Ea poate fi determinată cu funcția strlen (vezi mai jos), dar putem controla parcurgerea șirului știind că după ultimul caracter valid din șir apare caracterul nul.</p>

                    <p className="text-2xl  font-extrabold p-8 mt-[5vw] underline md:underline-offset-4" >Funcții pentru șiruri de caractere</p>
                        <div>
                            <ul className="p-2 ">
                                <li className=" hover:text-purple-800 font-extrabold"><a class="nav-link" href="#c1">-strlen</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c2">-strcpy</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c3">-strncpy</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c4">-strcat</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c5">-strchr</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c6">-strstr</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c7">-strcmp</a></li>
                                <li className=" hover:text-purple-800  font-extrabold"><a class="nav-link" href="#c8">-strtok</a></li>
                            </ul>      
                        </div>

                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c1">Strlen</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c2">Strcpy</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c3">Strncpy</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c4">Strcat</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c5">Strchr</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c6">Strstr</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c7">Strcmp</p>
                        ...
                        <p  className="text-2xl  font-bold p-8 mt-[5vw] " id="c8">Strtok</p>
